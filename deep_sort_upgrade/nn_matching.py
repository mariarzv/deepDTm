...
def _nn_euclidean_distance(x, y):
    ...
    distances = torchreid.metrics.distance.compute_distance_matrix(x_, y_, metric='euclidean')
...
def _nn_cosine_distance(x, y):
    ...
    distances = torchreid.metrics.distance.compute_distance_matrix(x_, y_, metric='cosine')
